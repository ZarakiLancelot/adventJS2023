...
// a derecha o izquierda (lo que maximice la distancia recorrida final) y luego ir a la
// izquierda.
...
// dos veces +2, luego con el * puede ir a la derecha otra vez para maximizar la distancia
...
function maxDistance(movements) {
  ...
  for (const movement of movements) {
    ...
    if (movement === "<") distance--;
    if (movement === "*") asterisc++;
  }
  return Math.abs(distance) + asterisc;
}
